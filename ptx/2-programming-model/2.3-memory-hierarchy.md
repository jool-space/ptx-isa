...
![Figure 3 Memory Hierarchy](../_images/memory-hierarchy-with-clusters.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/memory-hierarchy-with-clusters.png")
