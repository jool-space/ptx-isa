...
![Figure 3 Memory Hierarchy](../_images/memory-hierarchy-with-clusters.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/memory-hierarchy-with-clusters.png")
