...
![Figure 1 Grid with CTAs](../_images/grid-with-CTAs.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/grid-with-CTAs.png")

Figure 1 Grid with CTAs


![Figure 2 Grid with clusters](../_images/grid-with-clusters.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/grid-with-clusters.png")
