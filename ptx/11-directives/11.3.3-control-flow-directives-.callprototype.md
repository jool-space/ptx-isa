...
Optional `.abi_preserve` and `.abi_preserve_control` directives are used to specify the number of general purpose registers and control registers. See description of Performance-Tuning Directives: .abi_preserve and Performance-Tuning Directives: .abi_preserve_control for more details.
