...
#####  9.7.17.3.1. Leading Dimension Stride: relative offset or absolute address
...
####### 9.7.17.3.1.2.1. Restrictions on the Leading Dimension Absolute Address Stride
...
![Figure 188 K major, no-swizzling and tf32 type](../_images/async-warpgroup-k-no-swizzle-tf32.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-k-no-swizzle-tf32.png")
...
![Figure 189 K major, 32B swizzling and tf32 type](../_images/async-warpgroup-k-32B-swizzle-tf32.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-k-32B-swizzle-tf32.png")
...
![Figure 190 MN major, no-swizzling and bf16 type](../_images/async-warpgroup-mn-no-swizzle-bf16.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-mn-no-swizzle-bf16.png")
...
![Figure 191 MN major, 32B swizzling and bf16 type](../_images/async-warpgroup-mn-32B-swizzle-bf16.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-mn-32B-swizzle-bf16.png")
...
![Figure 192 MN major, 64B swizzling and bf16 type](../_images/async-warpgroup-mn-64B-swizzle-bf16.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-mn-64B-swizzle-bf16.png")
