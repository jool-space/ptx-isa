...
Following are the restrictions on the absolute address stride mode:
  ...
  2. Only K-Major mode is supported. That is, the transpose bits(bits #15 and #16) in Instruction descriptor must be 0.
...
Examples
  ...
  * K-Major, no-swizzling and tf32 type: Figure 191

![Figure 191 K major, no-swizzling and tf32 type](../_images/async-warpgroup-k-no-swizzle-tf32.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-k-no-swizzle-tf32.png")
...
Encoding of SBO in descriptor | (SBO) >> 4 = 8  
  * K-Major, 32B swizzling and tf32 type: Figure 192

![Figure 192 K major, 32B swizzling and tf32 type](../_images/async-warpgroup-k-32B-swizzle-tf32.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-k-32B-swizzle-tf32.png")
...
Encoding of SBO in descriptor | (SBO) >> 4 = 16  
  * MN-Major, no-swizzling and bf16 type: Figure 193

![Figure 193 MN major, no-swizzling and bf16 type](../_images/async-warpgroup-mn-no-swizzle-bf16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-mn-no-swizzle-bf16.png")
...
Encoding of LBO in descriptor | (LBO) >> 4 = 16  
Encoding of SBO in descriptor | (SBO) >> 4 = 8  
  * MN-Major, 32B swizzling and bf16 type: Figure 194

![Figure 194 MN major, 32B swizzling and bf16 type](../_images/async-warpgroup-mn-32B-swizzle-bf16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-mn-32B-swizzle-bf16.png")
...
Encoding of SBO in descriptor | (SBO) >> 4 = 32  
  * MN-Major, 64B swizzling and bf16 type: Figure 195

![Figure 195 MN major, 64B swizzling and bf16 type](../_images/async-warpgroup-mn-64B-swizzle-bf16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-mn-64B-swizzle-bf16.png")
