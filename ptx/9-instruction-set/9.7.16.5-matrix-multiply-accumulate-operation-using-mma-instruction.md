...
The layout of the fragments held by different threads is shown below:
    ...
    * Fragment layout for Row Major matrix A is shown in Figure 49.

![Figure 49 MMA .m8n8k4 fragment layout for row-major matrix A with `.f16` type](../_images/mma-884-A-row-f16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-884-A-row-f16.png")
...
The row and column of a matrix fragment can be computed as:
    ...
    * Fragment layout for Column Major matrix A is shown in Figure 50.

The layout of the fragments held by different threads is shown below:

![Figure 50 MMA .m8n8k4 fragment layout for column-major matrix A with `.f16` type](../_images/mma-884-A-col-f16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-884-A-col-f16.png")
...
The layout of the fragments held by different threads is shown below:
    ...
    * Fragment layout for Row Major matrix B is shown in Figure 51.

![Figure 51 MMA .m8n8k4 fragment layout for row-major matrix B with `.f16` type](../_images/mma-884-B-row-f16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-884-B-row-f16.png")
...
The row and column of a matrix fragment can be computed as:
    ...
    * Fragment layout for Column Major matrix B is shown in Figure 52.

![Figure 52 MMA .m8n8k4 fragment layout for column-major matrix B with `.f16` type](../_images/mma-884-B-col-f16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-884-B-col-f16.png")
...
The layout of the fragments held by different threads is shown below:
    ...
    * Fragment layout for accumulator matrix when `.ctype` is `.f16` is shown in Figure 53.

![Figure 53 MMA .m8n8k4 fragment layout for matrix C/D with `.ctype` = `.f16`](../_images/mma-884-C-f16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-884-C-f16.png")
...
The row and column of a matrix fragment can be computed as:
    ...
    * Fragment layout for accumulator matrix when `.ctype` is `.f32` is shown in Figure 54 and Figure 55.

![Figure 54 MMA .m8n8k4 computation 1 and 2 fragment layout for matrix C/D with `.ctype` = `.f32`](../_images/mma-884-C-f32-1.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-884-C-f32-1.png")

Figure 54 MMA .m8n8k4 computation 1 and 2 fragment layout for matrix C/D with `.ctype` = `.f32`

![Figure 55 MMA .m8n8k4 computation 3 and 4 fragment layout for matrix C/D with `.ctype` = `.f32`](../_images/mma-884-C-f32-2.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-884-C-f32-2.png")
...
![Figure 56 MMA .m8n8k4 fragment layout for matrix A with `.f64` type](../_images/mma-884-A-f64.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-884-A-f64.png")
...
![Figure 57 MMA .m8n8k4 fragment layout for matrix B with `.f64` type](../_images/mma-884-B-f64.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-884-B-f64.png")
...
![Figure 58 MMA .m8n8k4 fragment layout for accumulator matrix C/D with `.f64` type](../_images/mma-884-C-f64.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-884-C-f64.png")
...
![Figure 59 MMA .m8n8k16 fragment layout for matrix A with `.u8`/`.s8` type](../_images/mma-8816-A-i8.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-8816-A-i8.png")
...
![Figure 60 MMA .m8n8k16 fragment layout for matrix B with `.u8`/`.s8` type](../_images/mma-8816-B-i8.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-8816-B-i8.png")
...
![Figure 61 MMA .m8n8k16 fragment layout for accumulator matrix C/D with `.s32` type](../_images/mma-8816-C-i8.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-8816-C-i8.png")
...
![Figure 62 MMA .m8n8k32 fragment layout for matrix A with `.u4`/`.s4` type](../_images/mma-8832-A-i4.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-8832-A-i4.png")
...
![Figure 63 MMA .m8n8k32 fragment layout for matrix B with `.u4`/`.s4` type](../_images/mma-8832-B-i4.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-8832-B-i4.png")
...
![Figure 64 MMA .m8n8k32 fragment layout for accumulator matrix C/D with `.s32` type](../_images/mma-8832-C-i4.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-8832-C-i4.png")
...
![Figure 65 MMA .m8n8k128 fragment layout for matrix A with `.b1` type.](../_images/mma-88128-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-88128-A.png")
...
![Figure 66 MMA .m8n8k128 fragment layout for matrix B with `.b1` type.](../_images/mma-88128-B.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-88128-B.png")
...
![Figure 67 MMA .m8n8k128 fragment layout for accumulator matrix C/D with `.s32` type](../_images/mma-88128-C.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-88128-C.png")
...
![Figure 68 MMA .m16n8k4 fragment layout for matrix A with `.tf32` type.](../_images/mma-1684-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-1684-A.png")
...
> 
> ![mma-1684-A.png](../_images/mma-1684-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-1684-A.png")
> 
...
> 
> ![mma-1684-B.png](../_images/mma-1684-B.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-1684-B.png")
> 
...
> 
> ![mma-1684-C.png](../_images/mma-1684-C.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-1684-C.png")
> 
...
> 
> ![mma-1688-A-f16.png](../_images/mma-1688-A-f16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-1688-A-f16.png")
> 
...
> 
> ![mma-1688-A-tf32.png](../_images/mma-1688-A-tf32.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-1688-A-tf32.png")
> 
...
![Figure 76 MMA .m16n8k8 fragment layout for matrix A with `.f64` type.](../_images/mma-1688-A-tf32.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-1688-A-tf32.png")
...
> 
> ![mma-1688-B-f16.png](../_images/mma-1688-B-f16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-1688-B-f16.png")
> 
...
> 
> ![mma-1688-B-tf32.png](../_images/mma-1688-B-tf32.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-1688-B-tf32.png")
> 
...
> 
> ![mma-1688-C.png](../_images/mma-1688-C.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-1688-C.png")
> 
...
> 
> ![mma-16816-A-f16.png](../_images/mma-16816-A-f16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16816-A-f16.png")
> 
...
> 
> ![mma-16816-A-f64.png](../_images/mma-16816-A-f64.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16816-A-f64.png")
> 
...
> 
> ![mma-16816-B-f16.png](../_images/mma-16816-B-f16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16816-B-f16.png")
> 
...
> 
> ![sparse-mma-16816-tf32-B.png](../_images/sparse-mma-16816-tf32-B.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16816-tf32-B.png")
> 
...
![Figure 86 MMA .m16n8k16 fragment layout for accumulator matrix matrix C/D.](../_images/mma-16816-C-f16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16816-C-f16.png")
...
![Figure 87 MMA .m16n8k16 fragment layout for matrix A with `.u8` / `.s8` type.](../_images/mma-16816-A-i8.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16816-A-i8.png")
...
![Figure 88 MMA .m16n8k16 fragment layout for matrix B with `.u8` / `.s8` type.](../_images/mma-16816-B-i8.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16816-B-i8.png")
...
![Figure 89 MMA .m16n8k16 fragment layout for accumulator matrix C/D with `.s32` type.](../_images/mma-16816-C-i8.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16816-C-i8.png")
...
>   
> The layout of the fragments held by different threads is shown in Figure 90.
> 
> ![mma-16832-A-i4.png](../_images/mma-16832-A-i4.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16832-A-i4.png")
> 
...
> 
> ![mma-16832-A-i8.png](../_images/mma-16832-A-i8.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16832-A-i8.png")
> 
...
> 
> ![mma-16832-B-i4.png](../_images/mma-16832-B-i4.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16832-B-i4.png")
> 
...
> 
> ![mma-16832-B-i8_1.png](../_images/mma-16832-B-i8_1.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16832-B-i8_1.png")
> 
> Figure 93 MMA .m16n8k32 fragment layout for rows 0–15 of matrix B with `.u8` / `.s8` / `.e4m3` / `.e5m2` / `.e3m2` / `.e2m3` / `.e2m1` type.
> 
> ![mma-16832-B-i8_2.png](../_images/mma-16832-B-i8_2.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16832-B-i8_2.png")
> 
...
![Figure 95 MMA .m16n8k32 fragment layout for accumulator matrix C/D with `.s32` / `.f32` / `.f16` type.](../_images/mma-16832-C.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16832-C.png")
...
![Figure 96 MMA .m16n8k64 fragment layout for matrix A with `.u4` / `.s4` / `.e2m1` type.](../_images/mma-16864-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16864-A.png")
...
The layout of the fragments held by different threads is shown in Figure 97 and Figure 98.

![Figure 97 MMA .m16n8k64 fragment layout for rows 0–31 of matrix B with `.u4` / `.s4` / `.e2m1` type.](../_images/mma-16864-B_1.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16864-B_1.png")

Figure 97 MMA .m16n8k64 fragment layout for rows 0–31 of matrix B with `.u4` / `.s4` / `.e2m1` type.

![Figure 98 MMA .m16n8k64 fragment layout for rows 32–63 of matrix B with `.u4` / `.s4` / `.e2m1` type.](../_images/mma-16864-B_2.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16864-B_2.png")
...
![Figure 99 MMA .m16n8k64 fragment layout for accumulator matrix C/D with `.s32` / `.f32` type.](../_images/mma-16864-C.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-16864-C.png")
...
![Figure 100 MMA .m16n8k128 fragment layout for matrix A with `.b1` type.](../_images/mma-168128-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-168128-A.png")
...
![Figure 101 MMA .m16n8k128 fragment layout for matrix B with `.b1` type.](../_images/mma-168128-B.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-168128-B.png")
...
The layout of the fragments held by different threads is shown in Figure 102.

![Figure 102 MMA .m16n8k128 fragment layout for accumulator matrix C/D with `.s32` type.](../_images/mma-168128-C.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-168128-C.png")
...
![Figure 103 MMA .m16n8k256 fragment layout for matrix A with `.b1` type.](../_images/mma-168256-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-168256-A.png")
...
The layout of the fragments held by different threads is shown in Figure 104 and Figure 105.

![Figure 104 MMA .m16n8k256 fragment layout for rows 0–127 of matrix B with `.b1` type.](../_images/mma-168256-B_1.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-168256-B_1.png")

Figure 104 MMA .m16n8k256 fragment layout for rows 0–127 of matrix B with `.b1` type.

![Figure 105 MMA .m16n8k256 fragment layout for rows 128–255 of matrix B with `.b1` type.](../_images/mma-168256-B_2.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-168256-B_2.png")
...
The layout of the fragments held by different threads is shown in Figure 106.

![Figure 106 MMA .m16n8k256 fragment layout for accumulator matrix C/D with `.s32` type.](../_images/mma-168256-C.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-168256-C.png")
...
The valid combinations of `.kind`, `.stype` and `.scale_vec_size` are described in Table 45. For `mma` with `.kind::mxf4` when the qualifier `.scale_vec_size` is not specified, then it defaults to `2X`. In contrast, when `.kind` is specified as `.kind::mxf8f6f4` then the qualifier `.scale_vec_size` defaults to `1X`. However, for `.kind::mxf4nvf4`, it is mandatory to provide valid `.scale_vec_size`.
...
Each thread in a warp loads fragments of a row, with thread 0 receiving the first fragment in its register `r`, and so on. A group of four threads loads an entire row of the matrix as shown in Figure 107.

![Figure 107 ldmatrix fragment layout for one 8x8 Matrix with 16-bit elements](../_images/mma-ldmatrix-fragments.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-ldmatrix-fragments.png")
...
An entire row of the matrix can be loaded by a group of four consecutive and aligned threads. Each thread in a warp loads 4 consecutive columns across 2 rows as shown in the Figure 108.

![Figure 108 ldmatrix fragment layout for one 16x16 matrix with 8-bit elements](../_images/mma-ldmatrix-fragments-1616.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-ldmatrix-fragments-1616.png")
...
An entire row of the matrix can be loaded by a group of four consecutive and aligned threads. Each thread in a warp loads 4 consecutive columns as shown in Figure 109.

![Figure 109 ldmatrix fragment layout for one 8x16 matrix with 8-bit elements containing 4-bit/6-bit data](../_images/mma-ldmatrix-fragments-816.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-ldmatrix-fragments-816.png")
...
Each thread in a warp stores fragments of a row, with thread 0 storing the first fragment from its register `r`, and so on. A group of four threads stores an entire row of the matrix as shown in Figure 110.

![Figure 110 stmatrix fragment layout for one 8x8 matrix with 16-bit elements](../_images/mma-stmatrix-fragments.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-stmatrix-fragments.png")
...
![Figure 111 stmatrix fragment layout for one 16x8 matrix with 8 bit elements](../_images/mma-stmatrix-fragments-168.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-stmatrix-fragments-168.png")
...
Each thread in a warp holds a fragment of a row of the input matrix, with thread 0 holding the first fragment in register `a`, and so on. A group of four threads holds an entire row of the input matrix as shown in Figure 112.

![Figure 112 movmatrix source matrix fragment layout](../_images/mma-movmatrix-fragments-src.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-movmatrix-fragments-src.png")

Figure 112 movmatrix source matrix fragment layout

Each thread in a warp holds a fragment of a column of the result matrix, with thread 0 holding the first fragment in register `d`, and so on. A group of four threads holds an entire column of the result matrix as shown in Figure 113.

![Figure 113 movmatrix result matrix fragment layout](../_images/mma-movmatrix-fragments-dst.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/mma-movmatrix-fragments-dst.png")
