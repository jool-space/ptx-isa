...
Table 42 shows matrix shapes that are supported for the specified types for the `tcgen05.mma` operation.
...
_K_ can be specified explicitly if there are multiple values of _K_ supported for a given MMA variant. Otherwise, if _K_ can be uniquely determined as per the Table 42, then _K_ cannot be explicitly specified.
...
####### 9.7.17.2.3.1.1. Matrix fragments for shape .32x32b

A `tcgen05{.ld,.st}.32x32b` instruction has the following data vector register.

Fragment | Elements (low to high)  
---|---  
A vector expression containing `.num` number of `.b32` registers as mentioned in the Table 52. | r0, r1, …  
...
![Figure 183 Matrix Fragment for shape .32x32b](../_images/tcgen05-mma-fragment-3232b.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tcgen05-mma-fragment-3232b.png")

Figure 183 Matrix Fragment for shape .32x32b

####### 9.7.17.2.3.1.2. Matrix fragments for shape .16x64b
...
![Figure 184 Matrix Fragment for shape .16x64b](../_images/tcgen05-mma-fragment-1664b.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tcgen05-mma-fragment-1664b.png")

Figure 184 Matrix Fragment for shape .16x64b

####### 9.7.17.2.3.1.3. Matrix fragments for shape .16x128b
...
![Figure 185 Matrix Fragment for shape .16x128b](../_images/tcgen05-mma-fragment-16128b.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tcgen05-mma-fragment-16128b.png")

Figure 185 Matrix Fragment for shape .16x128b

####### 9.7.17.2.3.1.4. Matrix fragments for shape .16x256b

A `tcgen05{.ld,.st}.16x256b` instruction has the following data vector register.

Fragment | Elements (low to high)  
---|---  
A vector expression containing `.num` number of `.b32` registers as mentioned in the Table 52. | r0, r1, r2, r3, …  
...
![Figure 186 Matrix Fragment for shape .16x256b](../_images/tcgen05-mma-fragment-16256b.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tcgen05-mma-fragment-16256b.png")

Figure 186 Matrix Fragment for shape .16x256b

####### 9.7.17.2.3.1.5. Matrix fragments for shape .16x32bx2
...
![Figure 187 Matrix Fragment for shape .16x32bx2](../_images/tcgen05-mma-fragment-1632b2.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tcgen05-mma-fragment-1632b2.png")
