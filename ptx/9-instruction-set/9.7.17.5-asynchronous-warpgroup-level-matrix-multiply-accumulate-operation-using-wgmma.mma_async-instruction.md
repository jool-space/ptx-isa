...
![Figure 151 WGMMA .m64nNk16 register fragment layout for matrix A.](../_images/wgmma-64N16-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/wgmma-64N16-A.png")
...
![Figure 152 WGMMA .m64nNk16 register fragment layout for accumulator matrix D.](../_images/wgmma-64N16-D.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/wgmma-64N16-D.png")
...
![Figure 153 WGMMA .m64nNk8 register fragment layout for matrix A.](../_images/wgmma-64N8-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/wgmma-64N8-A.png")
...
![Figure 154 WGMMA .m64nNk8 register fragment layout for accumulator matrix D.](../_images/wgmma-64N8-D.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/wgmma-64N8-D.png")
...
![Figure 155 WGMMA .m64nNk32 register fragment layout for matrix A.](../_images/wgmma-64N32-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/wgmma-64N32-A.png")
...
The layout of the fragments held by different threads is shown in Figure 156.

![Figure 156 WGMMA .m64nNk32 register fragment layout for accumulator matrix D.](../_images/wgmma-64N32-D.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/wgmma-64N32-D.png")
...
The layout of the fragments held by different threads is shown in Figure 157.

![Figure 157 WGMMA .m64nNk256 register fragment layout for matrix A.](../_images/wgmma-64N256-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/wgmma-64N256-A.png")
...
The layout of the fragments held by different threads is shown in Figure 158.

![Figure 158 WGMMA .m64nNk256 register fragment layout for accumulator matrix D.](../_images/wgmma-64N256-D.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/wgmma-64N256-D.png")
...
The matrices in the shared memory are made up of one or more “swizzle layout atom”. The exact layout of these swizzle atoms depends on the swizzling mode, swizzle-atomicity, and the leading dimension. The layout of the swizzle are shown in Table 47.

Table 47 Various combinations of swizzling mode, leading dimension and swizzle-atom layout Swizzling mode | Leading Dimension / Major-ness | Swizzle atom layout (128b element)  
---|---|---  
...
The following are some example layouts of _MxK_ or _KxN_ matrices with various swizzling modes, and are in units of 128b elements as shown by each colored cell as shown in Figure 159, Figure 160, Figure 161, Figure 162, Figure 163, Figure 164, Figure 165, Figure 166.

![Figure 159 MN major 128B swizzling](../_images/async-warpgroup-smem-layout-128B-mn.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-smem-layout-128B-mn.png")

Figure 159 MN major 128B swizzling

![Figure 160 K major 128B swizzling](../_images/async-warpgroup-smem-layout-128B-k.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-smem-layout-128B-k.png")

Figure 160 K major 128B swizzling

![Figure 161 MN major 64B swizzling](../_images/async-warpgroup-smem-layout-64B-mn.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-smem-layout-64B-mn.png")

Figure 161 MN major 64B swizzling

![Figure 162 K major 64B swizzling](../_images/async-warpgroup-smem-layout-64B-k.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-smem-layout-64B-k.png")

Figure 162 K major 64B swizzling

![Figure 163 MN major 32B swizzling](../_images/async-warpgroup-smem-layout-32B-mn.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-smem-layout-32B-mn.png")

Figure 163 MN major 32B swizzling

![Figure 164 K major 32B swizzling](../_images/async-warpgroup-smem-layout-32B-k.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-smem-layout-32B-k.png")

Figure 164 K major 32B swizzling

![Figure 165 MN major interleaved](../_images/async-warpgroup-smem-layout-mn-interleaved.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-smem-layout-mn-interleaved.png")

Figure 165 MN major interleaved

![Figure 166 K major interleaved](../_images/async-warpgroup-smem-layout-k-interleaved.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-smem-layout-k-interleaved.png")
...
> ![async-warpgroup-smem-layout-128B-k-tf32.png](../_images/async-warpgroup-smem-layout-128B-k-tf32.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-smem-layout-128B-k-tf32.png")
> 
> Figure 167 K major

  * MN-Major: Figure 168

> ![async-warpgroup-smem-layout-128B-mn-tf32.png](../_images/async-warpgroup-smem-layout-128B-mn-tf32.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-smem-layout-128B-mn-tf32.png")
> 
> Figure 168 MN major
...
Examples
  ...
  * K-Major, no-swizzling and tf32 type: Figure 169

![Figure 169 K major, no-swizzling and tf32 type](../_images/async-warpgroup-k-no-swizzle-tf32.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-k-no-swizzle-tf32.png")
...
Encoding of SBO in descriptor | (SBO) >> 4 = 8  
  * K-Major, 32B swizzling and tf32 type: Figure 170

![Figure 170 K major, 32B swizzling and tf32 type](../_images/async-warpgroup-k-32B-swizzle-tf32.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-k-32B-swizzle-tf32.png")
...
Encoding of SBO in descriptor | (SBO) >> 4 = 16  
  * MN-Major, no-swizzling and bf16 type: Figure 171

![Figure 171 MN major, no-swizzling and bf16 type](../_images/async-warpgroup-mn-no-swizzle-bf16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-mn-no-swizzle-bf16.png")
...
Encoding of LBO in descriptor | (LBO) >> 4 = 16  
Encoding of SBO in descriptor | (SBO) >> 4 = 8  
  * MN-Major, 32B swizzling and bf16 type: Figure 172

![Figure 172 MN major, 32B swizzling and bf16 type](../_images/async-warpgroup-mn-32B-swizzle-bf16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-mn-32B-swizzle-bf16.png")
...
Encoding of SBO in descriptor | (SBO) >> 4 = 32  
  * MN-Major, 64B swizzling and bf16 type: Figure 173

![Figure 173 MN major, 64B swizzling and bf16 type](../_images/async-warpgroup-mn-64B-swizzle-bf16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/async-warpgroup-mn-64B-swizzle-bf16.png")
