...
![Figure 42 `mma` with block scaling of `.scale_vec::2X`](../_images/mma-block-scaling.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/mma-block-scaling.png")
...
![Figure 43 Selection of set of values for _SF_A_ based on `thread-id-a`](../_images/mma-scaling-thread-id-a-selection.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/mma-scaling-thread-id-a-selection.png")
...
![Figure 44 Selection of set of values for _SF_B_ based on `thread-id-b`](../_images/mma-scaling-thread-id-b-selection.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/mma-scaling-thread-id-b-selection.png")
...
![Figure 45 Selection of set of values for _SF_A_ or _SF_B_ based on `byte-id-a` or `byte-id-b`](../_images/mma-scaling-byte-id-selection.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/mma-scaling-byte-id-selection.png")
