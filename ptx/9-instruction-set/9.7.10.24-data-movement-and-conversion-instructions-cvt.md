...
Syntax
    ...
    cvt.rs{.relu}{.satfinite}{.pzo}.f16x2.f32        d, a, b, rbits;
    
    cvt.frnd2{.relu}{.satfinite}{.pzo}.bf16.f32      d, a;
    cvt.frnd2{.relu}{.satfinite}{.pzo}.bf16x2.f32    d, a, b;
    cvt.rs{.relu}{.satfinite}{.pzo}.bf16x2.f32       d, a, b, rbits;
    ...
    cvt.rs{.relu}.satfinite{.pzo}.f8x4type.f32          d, {a, b, e, f}, rbits;
    ...
    cvt.rs{.relu}.satfinite{.pzo}.f4x4type.f32           d, {a, b, e, f}, rbits;
    ...
    cvt.rs{.relu}.satfinite{.pzo}.f6x4type.f32           d, {a, b, e, f}, rbits;
...
// Random bits `rbits` semantics for `.rs` rounding:
  ...
  1. Destination type `.f16`: Refer Figure 39 for random bits layout details.

![Figure 39 Random bits layout for `.rs` rounding with `.f16` destination type](../_images/cvt-rs-rbits-layout-f16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/cvt-rs-rbits-layout-f16.png")

Figure 39 Random bits layout for `.rs` rounding with `.f16` destination type

  2. Destination type `.bf16`: Refer Figure 40 for random bits layout details.

![Figure 40 Random bits layout for `.rs` rounding with `.bf16` destination type](../_images/cvt-rs-rbits-layout-bf16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/cvt-rs-rbits-layout-bf16.png")

Figure 40 Random bits layout for `.rs` rounding with `.bf16` destination type

  3. Destination type `.e2m1x4`: Refer Figure 41 for random bits layout details.

![Figure 41 Random bits layout for `.rs` rounding with `.e2m1x4` destination type](../_images/cvt-rs-rbits-layout-f4.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/cvt-rs-rbits-layout-f4.png")

Figure 41 Random bits layout for `.rs` rounding with `.e2m1x4` destination type

  4. Destination type `.e5m2x4`, `.e4m3x4`, `.e3m2x4`, `.e2m3x4`: Refer Figure 42 for random bits layout details.

![Figure 42 Random bits layout for `.rs` rounding with `.e5m2x4`/`.e4m3x4`/`.e3m2x4`/`.e2m3x4` destination type](../_images/cvt-rs-rbits-layout-f8-f6.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/cvt-rs-rbits-layout-f8-f6.png")
