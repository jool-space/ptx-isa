...
![Figure 182 Tensor Memory Layout and Addressing](../_images/tensor-memory-layout.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tensor-memory-layout.png")
