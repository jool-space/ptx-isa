...
![Figure 46 MMA .m8n8k4 fragment layout for row-major matrix A with `.f16` type](../_images/mma-884-A-row-f16.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-A-row-f16.png")
...
![Figure 47 MMA .m8n8k4 fragment layout for column-major matrix A with `.f16` type](../_images/mma-884-A-col-f16.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-A-col-f16.png")
...
![Figure 48 MMA .m8n8k4 fragment layout for row-major matrix B with `.f16` type](../_images/mma-884-B-row-f16.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-B-row-f16.png")
...
![Figure 49 MMA .m8n8k4 fragment layout for column-major matrix B with `.f16` type](../_images/mma-884-B-col-f16.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-B-col-f16.png")
...
![Figure 50 MMA .m8n8k4 fragment layout for matrix C/D with `.ctype` = `.f16`](../_images/mma-884-C-f16.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-C-f16.png")
...
![Figure 51 MMA .m8n8k4 computation 1 and 2 fragment layout for matrix C/D with `.ctype` = `.f32`](../_images/mma-884-C-f32-1.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-C-f32-1.png")

Figure 51 MMA .m8n8k4 computation 1 and 2 fragment layout for matrix C/D with `.ctype` = `.f32`

![Figure 52 MMA .m8n8k4 computation 3 and 4 fragment layout for matrix C/D with `.ctype` = `.f32`](../_images/mma-884-C-f32-2.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-C-f32-2.png")
...
![Figure 53 MMA .m8n8k4 fragment layout for matrix A with `.f64` type](../_images/mma-884-A-f64.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-A-f64.png")
...
![Figure 54 MMA .m8n8k4 fragment layout for matrix B with `.f64` type](../_images/mma-884-B-f64.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-B-f64.png")
...
![Figure 55 MMA .m8n8k4 fragment layout for accumulator matrix C/D with `.f64` type](../_images/mma-884-C-f64.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-884-C-f64.png")
...
![Figure 56 MMA .m8n8k16 fragment layout for matrix A with `.u8`/`.s8` type](../_images/mma-8816-A-i8.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-8816-A-i8.png")
...
![Figure 57 MMA .m8n8k16 fragment layout for matrix B with `.u8`/`.s8` type](../_images/mma-8816-B-i8.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-8816-B-i8.png")
...
![Figure 58 MMA .m8n8k16 fragment layout for accumulator matrix C/D with `.s32` type](../_images/mma-8816-C-i8.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-8816-C-i8.png")
...
![Figure 59 MMA .m8n8k32 fragment layout for matrix A with `.u4`/`.s4` type](../_images/mma-8832-A-i4.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-8832-A-i4.png")
...
![Figure 60 MMA .m8n8k32 fragment layout for matrix B with `.u4`/`.s4` type](../_images/mma-8832-B-i4.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-8832-B-i4.png")
...
![Figure 61 MMA .m8n8k32 fragment layout for accumulator matrix C/D with `.s32` type](../_images/mma-8832-C-i4.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-8832-C-i4.png")
...
![Figure 62 MMA .m8n8k128 fragment layout for matrix A with `.b1` type.](../_images/mma-88128-A.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-88128-A.png")
...
![Figure 63 MMA .m8n8k128 fragment layout for matrix B with `.b1` type.](../_images/mma-88128-B.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-88128-B.png")
...
![Figure 64 MMA .m8n8k128 fragment layout for accumulator matrix C/D with `.s32` type](../_images/mma-88128-C.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-88128-C.png")
...
![Figure 65 MMA .m16n8k4 fragment layout for matrix A with `.tf32` type.](../_images/mma-1684-A.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1684-A.png")
...
![Figure 73 MMA .m16n8k8 fragment layout for matrix A with `.f64` type.](../_images/mma-1688-A-tf32.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-1688-A-tf32.png")
...
![Figure 83 MMA .m16n8k16 fragment layout for accumulator matrix matrix C/D.](../_images/mma-16816-C-f16.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16816-C-f16.png")
...
![Figure 84 MMA .m16n8k16 fragment layout for matrix A with `.u8` / `.s8` type.](../_images/mma-16816-A-i8.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16816-A-i8.png")
...
![Figure 85 MMA .m16n8k16 fragment layout for matrix B with `.u8` / `.s8` type.](../_images/mma-16816-B-i8.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16816-B-i8.png")
...
![Figure 86 MMA .m16n8k16 fragment layout for accumulator matrix C/D with `.s32` type.](../_images/mma-16816-C-i8.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16816-C-i8.png")
...
![Figure 92 MMA .m16n8k32 fragment layout for accumulator matrix C/D with `.s32` / `.f32` / `.f16` type.](../_images/mma-16832-C.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16832-C.png")
...
![Figure 93 MMA .m16n8k64 fragment layout for matrix A with `.u4` / `.s4` / `.e2m1` type.](../_images/mma-16864-A.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16864-A.png")
...
![Figure 94 MMA .m16n8k64 fragment layout for rows 0–31 of matrix B with `.u4` / `.s4` / `.e2m1` type.](../_images/mma-16864-B_1.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16864-B_1.png")

Figure 94 MMA .m16n8k64 fragment layout for rows 0–31 of matrix B with `.u4` / `.s4` / `.e2m1` type.

![Figure 95 MMA .m16n8k64 fragment layout for rows 32–63 of matrix B with `.u4` / `.s4` / `.e2m1` type.](../_images/mma-16864-B_2.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16864-B_2.png")
...
![Figure 96 MMA .m16n8k64 fragment layout for accumulator matrix C/D with `.s32` / `.f32` type.](../_images/mma-16864-C.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-16864-C.png")
...
![Figure 97 MMA .m16n8k128 fragment layout for matrix A with `.b1` type.](../_images/mma-168128-A.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168128-A.png")
...
![Figure 98 MMA .m16n8k128 fragment layout for matrix B with `.b1` type.](../_images/mma-168128-B.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168128-B.png")
...
![Figure 99 MMA .m16n8k128 fragment layout for accumulator matrix C/D with `.s32` type.](../_images/mma-168128-C.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168128-C.png")
...
![Figure 100 MMA .m16n8k256 fragment layout for matrix A with `.b1` type.](../_images/mma-168256-A.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168256-A.png")
...
![Figure 101 MMA .m16n8k256 fragment layout for rows 0–127 of matrix B with `.b1` type.](../_images/mma-168256-B_1.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168256-B_1.png")

Figure 101 MMA .m16n8k256 fragment layout for rows 0–127 of matrix B with `.b1` type.

![Figure 102 MMA .m16n8k256 fragment layout for rows 128–255 of matrix B with `.b1` type.](../_images/mma-168256-B_2.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168256-B_2.png")
...
![Figure 103 MMA .m16n8k256 fragment layout for accumulator matrix C/D with `.s32` type.](../_images/mma-168256-C.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-168256-C.png")
...
The valid combinations of `.kind`, `.stype` and `.scale_vec_size` are described in Table 39. For `mma` with `.kind::mxf4` when the qualifier `.scale_vec_size` is not specified, then it defaults to `2X`. In contrast, when `.kind` is specified as `.kind::mxf8f6f4` then the qualifier `.scale_vec_size` defaults to `1X`. However, for `.kind::mxf4nvf4`, it is mandatory to provide valid `.scale_vec_size`.
...
![Figure 104 ldmatrix fragment layout for one 8x8 Matrix with 16-bit elements](../_images/mma-ldmatrix-fragments.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-ldmatrix-fragments.png")
...
![Figure 105 ldmatrix fragment layout for one 16x16 matrix with 8-bit elements](../_images/mma-ldmatrix-fragments-1616.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-ldmatrix-fragments-1616.png")
...
![Figure 106 ldmatrix fragment layout for one 8x16 matrix with 8-bit elements containing 4-bit/6-bit data](../_images/mma-ldmatrix-fragments-816.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-ldmatrix-fragments-816.png")
...
![Figure 107 stmatrix fragment layout for one 8x8 matrix with 16-bit elements](../_images/mma-stmatrix-fragments.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-stmatrix-fragments.png")
...
![Figure 108 stmatrix fragment layout for one 16x8 matrix with 8 bit elements](../_images/mma-stmatrix-fragments-168.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-stmatrix-fragments-168.png")
...
![Figure 109 movmatrix source matrix fragment layout](../_images/mma-movmatrix-fragments-src.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-movmatrix-fragments-src.png")
...
![Figure 110 movmatrix result matrix fragment layout](../_images/mma-movmatrix-fragments-dst.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/mma-movmatrix-fragments-dst.png")
