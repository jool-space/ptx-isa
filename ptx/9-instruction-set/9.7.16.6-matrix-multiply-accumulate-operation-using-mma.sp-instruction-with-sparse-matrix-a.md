...
Figure 114 shows an example of a 16x16 matrix A represented in sparse format and sparsity selector indicating which thread in a group of four consecutive threads stores the metadata.

![Figure 114 Sparse MMA storage example](../_images/sparse-mma-storage-example.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-storage-example.png")
...
![Figure 115 Sparse MMA metadata example for `.f16`/`.bf16` type.](../_images/f16-metadata-example.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/f16-metadata-example.png")
...
![Figure 116 Sparse MMA metadata example for `.tf32` type.](../_images/tf32-metadata-example.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/tf32-metadata-example.png")
...
![Figure 117 Sparse MMA metadata example for `.u8`/`.s8` type.](../_images/u8s8-metadata-example.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/u8s8-metadata-example.png")
...
![Figure 118 Sparse MMA metadata example for `.u4`/`.s4` type.](../_images/u4s4-metadata-example.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/u4s4-metadata-example.png")
...
![Figure 119 Sparse MMA metadata example for `.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/fp8-metadata-example.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/fp8-metadata-example.png")
...
![Figure 120 Sparse MMA metadata example for `.e2m1` type with `.kind::mxf4` or `.kind::mxf4nvf4`](../_images/fp4-metadata-example.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/fp4-metadata-example.png")
...
![Figure 121 Sparse MMA .m16n8k16 fragment layout for matrix A with `.f16`/`.bf16` type.](../_images/sparse-mma-16816-f16-bf16-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16816-f16-bf16-A.png")
...
The row and column of a matrix fragment can be computed as:
  ...
  * Metadata: A `.b32` register containing 16 2-bit vectors each storing the index of a non-zero element of a 4-wide chunk of matrix A as shown in Figure 122.

> ![sparse-mma-metadata-16816-f16bf16.png](../_images/sparse-mma-metadata-16816-f16bf16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-metadata-16816-f16bf16.png")
> 
...
![Figure 123 Sparse MMA .m16n8k32 fragment layout for matrix A with `.f16`/`.bf16` type.](../_images/sparse-mma-16832-f16-bf16-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16832-f16-bf16-A.png")
...
![Figure 124 Sparse MMA .m16n8k32 fragment layout for matrix B with `.f16`/`.bf16` type.](../_images/sparse-mma-16832-f16bf16-B.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16832-f16bf16-B.png")
...
Figure 124 Sparse MMA .m16n8k32 fragment layout for matrix B with `.f16`/`.bf16` type.
  ...
  * Metadata: A `.b32` register containing 16 2-bit vectors with each pair of 2-bit vectors storing the indices of two non-zero element from a 4-wide chunk of matrix A as shown in Figure 125.

> ![sparse-mma-metadata-16832-f16bf16.png](../_images/sparse-mma-metadata-16832-f16bf16.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-metadata-16832-f16bf16.png")
> 
...
![Figure 126 Sparse MMA .m16n8k16 fragment layout for matrix A with `.tf32` type.](../_images/sparse-mma-16816-tf32-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16816-tf32-A.png")
...
The layout of the fragments held by different threads is shown in Figure 127.

![Figure 127 Sparse MMA .m16n8k16 fragment layout for matrix B with `.tf32` type.](../_images/sparse-mma-16816-tf32-B.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16816-tf32-B.png")
...
Figure 127 Sparse MMA .m16n8k16 fragment layout for matrix B with `.tf32` type.
  ...
  * Metadata: A `.b32` register containing 8 4-bit vectors each storing the index of a non-zero element of a 2-wide chunk of matrix A as shown in Figure 128.

> ![sparse-mma-metadata-16816-tf32.png](../_images/sparse-mma-metadata-16816-tf32.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-metadata-16816-tf32.png")
> 
...
The layout of the fragments held by different threads is shown in Figure 129.

![Figure 129 Sparse MMA .m16n8k8 fragment layout for matrix A with `.tf32` type.](../_images/sparse-mma-1688-tf32-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-1688-tf32-A.png")
...
The row and column of a matrix fragment can be computed as:
  ...
  * Metadata: A `.b32` register containing 8 4-bit vectors each storing the index of a non-zero element of a 2-wide chunk of matrix A as shown in Figure 130.

> ![sparse-mma-metadata-1688-tf32.png](../_images/sparse-mma-metadata-1688-tf32.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-metadata-1688-tf32.png")
> 
...
The layout of the fragments held by different threads is shown in Figure 131.

![Figure 131 Sparse MMA .m16n8k32 fragment layout for matrix A with `.u8`/`.s8` type.](../_images/sparse-mma-16832-u8s8-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16832-u8s8-A.png")
...
Figure 131 Sparse MMA .m16n8k32 fragment layout for matrix A with `.u8`/`.s8` type.
  ...
  * Metadata: A `.b32` register containing 16 2-bit vectors with each pair of 2-bit vectors storing the indices of two non-zero elements from a 4-wide chunk of matrix A as shown in Figure 132.

> ![sparse-mma-metadata-16832-u8s8.png](../_images/sparse-mma-metadata-16832-u8s8.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-metadata-16832-u8s8.png")
> 
...
The layout of the fragments held by different threads is shown in Figure 133 and Figure 134.

![Figure 133 Sparse MMA .m16n8k64 fragment layout for columns 0–31 of matrix A with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/sparse-mma-16864-u8s8-A-first32col.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16864-u8s8-A-first32col.png")

Figure 133 Sparse MMA .m16n8k64 fragment layout for columns 0–31 of matrix A with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.

![Figure 134 Sparse MMA .m16n8k64 fragment layout for columns 32–63 of matrix A with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/sparse-mma-16864-u8s8-A-last32col.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16864-u8s8-A-last32col.png")
...
The layout of the fragments held by different threads is shown in Figure 135, Figure 136, Figure 137 and Figure 138.

![Figure 135 Sparse MMA .m16n8k64 fragment layout for rows 0–15 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/sparse-mma-16864-u8s8-B1.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16864-u8s8-B1.png")

Figure 135 Sparse MMA .m16n8k64 fragment layout for rows 0–15 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.

![Figure 136 Sparse MMA .m16n8k64 fragment layout for rows 16–31 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/sparse-mma-16864-u8s8-B2.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16864-u8s8-B2.png")

Figure 136 Sparse MMA .m16n8k64 fragment layout for rows 16–31 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.

![Figure 137 Sparse MMA .m16n8k64 fragment layout for rows 32–47 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/sparse-mma-16864-u8s8-B3.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16864-u8s8-B3.png")

Figure 137 Sparse MMA .m16n8k64 fragment layout for rows 32–47 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.

![Figure 138 Sparse MMA .m16n8k64 fragment layout for rows 48–63 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/sparse-mma-16864-u8s8-B4.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16864-u8s8-B4.png")
...
Figure 138 Sparse MMA .m16n8k64 fragment layout for rows 48–63 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.
  ...
  * Metadata: A `.b32` register containing 16 2-bit vectors with each pair of 2-bit vectors storing the indices of two non-zero elements from a 4-wide chunk of matrix A as shown in Figure 139 and Figure 140.

> ![sparse-mma-metadata-16864-u8s8-first32col.png](../_images/sparse-mma-metadata-16864-u8s8-first32col.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-metadata-16864-u8s8-first32col.png")
> 
> Figure 139 Sparse MMA .m16n8k64 metadata layout for columns 0–31 for `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.
> 
> ![sparse-mma-metadata-16864-u8s8-last32col.png](../_images/sparse-mma-metadata-16864-u8s8-last32col.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-metadata-16864-u8s8-last32col.png")
> 
...
The layout of the fragments held by different threads is shown in Figure 141.

![Figure 141 Sparse MMA .m16n8k64 fragment layout for matrix A with `.u4`/`.s4` type.](../_images/sparse-mma-16864-u4s4-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-16864-u4s4-A.png")
...
Figure 141 Sparse MMA .m16n8k64 fragment layout for matrix A with `.u4`/`.s4` type.
  ...
  * Metadata: A `.b32` register containing 16 2-bit vectors with each pair of 2-bit vectors storing the indices of four non-zero elements from a 8-wide chunk of matrix A as shown in Figure 142.

> ![sparse-mma-metadata-16864-u4s4.png](../_images/sparse-mma-metadata-16864-u4s4.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-metadata-16864-u4s4.png")
> 
...
The layout of the fragments held by different threads is shown in Figure 143 and Figure 144.

![Figure 143 Sparse MMA .m16n8k128 fragment layout for columns 0–63 of matrix A with `.u4`/`.s4`/`.e2m1` type.](../_images/sparse-mma-168128-u4s4-A-first64col.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-168128-u4s4-A-first64col.png")

Figure 143 Sparse MMA .m16n8k128 fragment layout for columns 0–63 of matrix A with `.u4`/`.s4`/`.e2m1` type.

![Figure 144 Sparse MMA .m16n8k128 fragment layout for columns 64–127 of matrix A with `.u4`/`.s4`/`.e2m1` type.](../_images/sparse-mma-168128-u4s4-A-last64col.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-168128-u4s4-A-last64col.png")
...
The layout of the fragments held by different threads is shown in Figure 145, Figure 146, Figure 147, Figure 148.

![Figure 145 Sparse MMA .m16n8k128 fragment layout for rows 0–31 of matrix B with `.u4`/`.s4`/`.e2m1` type.](../_images/sparse-mma-168128-u4s4-B1.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-168128-u4s4-B1.png")

Figure 145 Sparse MMA .m16n8k128 fragment layout for rows 0–31 of matrix B with `.u4`/`.s4`/`.e2m1` type.

![Figure 146 Sparse MMA .m16n8k128 fragment layout for rows 32–63 of matrix B with `.u4`/`.s4`/`.e2m1` type.](../_images/sparse-mma-168128-u4s4-B2.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-168128-u4s4-B2.png")

Figure 146 Sparse MMA .m16n8k128 fragment layout for rows 32–63 of matrix B with `.u4`/`.s4`/`.e2m1` type.

![Figure 147 Sparse MMA .m16n8k128 fragment layout for rows 64–95 of matrix B with `.u4`/`.s4`/`.e2m1` type.](../_images/sparse-mma-168128-u4s4-B3.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-168128-u4s4-B3.png")

Figure 147 Sparse MMA .m16n8k128 fragment layout for rows 64–95 of matrix B with `.u4`/`.s4`/`.e2m1` type.

![Figure 148 Sparse MMA .m16n8k128 fragment layout for rows 96–127 of matrix B with `.u4`/`.s4`/`.e2m1` type.](../_images/sparse-mma-168128-u4s4-B4.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-168128-u4s4-B4.png")
...
Figure 148 Sparse MMA .m16n8k128 fragment layout for rows 96–127 of matrix B with `.u4`/`.s4`/`.e2m1` type.
  ...
  * Metadata: A `.b32` register containing 16 2-bit vectors with each pair of 2-bit vectors storing the indices of four non-zero elements from a 8-wide chunk of matrix A as shown in Figure 149 and Figure 150.

> ![sparse-mma-metadata-168128-u4s4-first64col.png](../_images/sparse-mma-metadata-168128-u4s4-first64col.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-metadata-168128-u4s4-first64col.png")
> 
> Figure 149 Sparse MMA .m16n8k128 metadata layout for columns 0–63 for `.u4`/`.s4`/`.e2m1` type.
> 
> ![sparse-mma-metadata-168128-u4s4-last64col.png](../_images/sparse-mma-metadata-168128-u4s4-last64col.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-mma-metadata-168128-u4s4-last64col.png")
> 
