...
_K_ cannot be explicitly specified but is implicitly determined by the MMA-kind and the sparsity, as shown in the Table 39.
...
---|---  
A vector expression containing `.num` number of `.b32` registers as mentioned in the Table 47. | r0, r1, …  
...
![Figure 183 Matrix Fragment for shape .32x32b](../_images/tcgen05-mma-fragment-3232b.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-fragment-3232b.png")
...
![Figure 184 Matrix Fragment for shape .16x64b](../_images/tcgen05-mma-fragment-1664b.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-fragment-1664b.png")
...
![Figure 185 Matrix Fragment for shape .16x128b](../_images/tcgen05-mma-fragment-16128b.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-fragment-16128b.png")
...
Fragment | Elements (low to high)  
---|---  
A vector expression containing `.num` number of `.b32` registers as mentioned in the Table 47. | r0, r1, r2, r3, …  
...
![Figure 186 Matrix Fragment for shape .16x256b](../_images/tcgen05-mma-fragment-16256b.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-fragment-16256b.png")
...
![Figure 187 Matrix Fragment for shape .16x32bx2](../_images/tcgen05-mma-fragment-1632b2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-fragment-1632b2.png")
