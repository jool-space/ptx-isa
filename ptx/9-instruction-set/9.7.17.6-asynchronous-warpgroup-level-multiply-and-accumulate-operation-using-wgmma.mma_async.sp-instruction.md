...
Matrix A and its corresponding input operand to the sparse wgmma is similar to the diagram shown in Figure 114, with an appropriate matrix size.
...
![Figure 174 Sparse WGMMA metadata example for `.f16`/`.bf16` type.](../_images/f16-metadata-example.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/f16-metadata-example.png")
...
![Figure 175 Sparse WGMMA metadata example for `.tf32` type.](../_images/tf32-metadata-example.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/tf32-metadata-example.png")
...
![Figure 176 Sparse WGMMA metadata example for `.e4m3`/`.e5m2` type.](../_images/u8s8-metadata-example.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/u8s8-metadata-example.png")
...
![Figure 177 Sparse WGMMA metadata example for `.u8`/`.s8` type.](../_images/u8s8-metadata-example.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/u8s8-metadata-example.png")
...
>   
> The layout of the fragments held by different threads is shown in Figure 178.
> 
> ![sparse-wgmma-64N32-f16-bf16-A.png](../_images/sparse-wgmma-64N32-f16-bf16-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-wgmma-64N32-f16-bf16-A.png")
> 
...
Figure 179 shows the mapping of the metadata bits to the elements of matrix A for a warp. In this figure, variable `i` represents the value of the sparsity selector operand.
...
>   
> The layout of the fragments held by different threads is shown in Figure 180.
> 
> ![sparse-wgmma-64N16-tf32-A.png](../_images/sparse-wgmma-64N16-tf32-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-wgmma-64N16-tf32-A.png")
> 
...
Figure 181 shows the mapping of the metadata bits to the elements of matrix A for a warp. In this figure, variable `i` represents the value of the sparsity selector operand.
...
>   
> The layout of the fragments held by different threads is shown in Figure 182.
> 
> ![sparse-wgmma-64N64-e4m3-e5m2-s8-u8-A.png](../_images/sparse-wgmma-64N64-e4m3-e5m2-s8-u8-A.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/sparse-wgmma-64N64-e4m3-e5m2-s8-u8-A.png")
> 
...
Figure 183 shows the mapping of the metadata bits to the elements of columns 0–31 of matrix A.
...
Figure 184 shows the mapping of the metadata bits to the elements of columns 32–63 of matrix A.
