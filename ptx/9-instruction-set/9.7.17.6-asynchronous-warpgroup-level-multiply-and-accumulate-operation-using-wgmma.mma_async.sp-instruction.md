...
![Figure 174 Sparse WGMMA metadata example for `.f16`/`.bf16` type.](../_images/f16-metadata-example.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/f16-metadata-example.png")
...
![Figure 175 Sparse WGMMA metadata example for `.tf32` type.](../_images/tf32-metadata-example.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tf32-metadata-example.png")
...
![Figure 176 Sparse WGMMA metadata example for `.e4m3`/`.e5m2` type.](../_images/u8s8-metadata-example.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/u8s8-metadata-example.png")
...
![Figure 177 Sparse WGMMA metadata example for `.u8`/`.s8` type.](../_images/u8s8-metadata-example.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/u8s8-metadata-example.png")
...
> 
> ![sparse-wgmma-64N32-f16-bf16-A.png](../_images/sparse-wgmma-64N32-f16-bf16-A.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/sparse-wgmma-64N32-f16-bf16-A.png")
> 
...
> 
> ![sparse-wgmma-64N16-tf32-A.png](../_images/sparse-wgmma-64N16-tf32-A.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/sparse-wgmma-64N16-tf32-A.png")
> 
...
> 
> ![sparse-wgmma-64N64-e4m3-e5m2-s8-u8-A.png](../_images/sparse-wgmma-64N64-e4m3-e5m2-s8-u8-A.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/sparse-wgmma-64N64-e4m3-e5m2-s8-u8-A.png")
> 
