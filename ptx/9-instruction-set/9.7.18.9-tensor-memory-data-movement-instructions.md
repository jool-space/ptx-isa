...
A contiguous set of 16 elements of 4-bits each followed by 8 bytes of padding can be converted into 16 elements of 8-bits each as shown in Figure 197.

![Figure 197 Decompression from 4-bit to 8-bit](../_images/tcgen05-decompression-4b8b.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/tcgen05-decompression-4b8b.png")

Figure 197 Decompression from 4-bit to 8-bit

The individual 4-bit to 8-bit decompression would look like as shown in Figure 198.

![Figure 198 Individual decompression from 4-bit to 8-bit](../_images/tcgen05-decompression-4b8b-individual.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/tcgen05-decompression-4b8b-individual.png")

Figure 198 Individual decompression from 4-bit to 8-bit

###### 9.7.18.9.1.2. Decompression of 6-bit floating point to 8-bit type

A contiguous set of 16 elements of 6-bits each followed by 4 bytes of padding is decompressed into 16 elements of 8-bits each as shown in Figure 199.

![Figure 199 Decompression from 6-bit to 8-bit](../_images/tcgen05-decompression-6b8b.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/tcgen05-decompression-6b8b.png")

Figure 199 Decompression from 6-bit to 8-bit

The individual 6-bit to 8-bit decompression for types `E3M2` and `E2M3` is shown in Figure 200 and Figure 201 respectively.

![Figure 200 Individual decompression from 6-bit to 8-bit for E3M2 type](../_images/tcgen05-decompression-6b8b-individual1.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/tcgen05-decompression-6b8b-individual1.png")

Figure 200 Individual decompression from 6-bit to 8-bit for E3M2 type

![Figure 201 Individual decompression from 6-bit to 8-bit for E2M3 type](../_images/tcgen05-decompression-6b8b-individual2.png "https://docs.nvidia.com/cuda/developer-preview/13.4/parallel-thread-execution/_images/tcgen05-decompression-6b8b-individual2.png")
...
Qualifier `.cta_group` specifies the number of CTAs whose Tensor Memory is accessed when a single thread of a single CTA executes the `tcgen05.cp` instruction. When `.cta_group::1` is specified, the data is copied into the Tensor Memory of the current CTA. A thread executing a `tcgen05.cp` instruction with `.cta_group::2` causes both the current and peer CTA to copy data from their shared memory to Tensor Memory.
