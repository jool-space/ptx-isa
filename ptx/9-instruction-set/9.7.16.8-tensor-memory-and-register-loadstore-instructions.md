...
![Figure 193 Pack/Unpack operations for tcgen05 ld/st](../_images/tcgen05-ld-st-pack-unpack.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-ld-st-pack-unpack.png")
...
Table 47 Various-combinations of .num and .shape .num | .shape  
---|---  
...
Table 48 Various-combinations of .num and .shape .num | .shape  
---|---  
.16x32bx2 / .16x64b / .32x32b | .16x128b | .16x256b  
`.x1` | 1 | 2 | 4  
`.x2` | 2 | 4 | 8  
