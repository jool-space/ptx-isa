...
![Figure 111 Sparse MMA storage example](../_images/sparse-mma-storage-example.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-storage-example.png")
...
![Figure 112 Sparse MMA metadata example for `.f16`/`.bf16` type.](../_images/f16-metadata-example.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/f16-metadata-example.png")
...
![Figure 113 Sparse MMA metadata example for `.tf32` type.](../_images/tf32-metadata-example.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/tf32-metadata-example.png")
...
![Figure 114 Sparse MMA metadata example for `.u8`/`.s8` type.](../_images/u8s8-metadata-example.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/u8s8-metadata-example.png")
...
![Figure 115 Sparse MMA metadata example for `.u4`/`.s4` type.](../_images/u4s4-metadata-example.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/u4s4-metadata-example.png")
...
![Figure 116 Sparse MMA metadata example for `.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/fp8-metadata-example.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/fp8-metadata-example.png")
...
![Figure 117 Sparse MMA metadata example for `.e2m1` type with `.kind::mxf4` or `.kind::mxf4nvf4`](../_images/fp4-metadata-example.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/fp4-metadata-example.png")
...
![Figure 118 Sparse MMA .m16n8k16 fragment layout for matrix A with `.f16`/`.bf16` type.](../_images/sparse-mma-16816-f16-bf16-A.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-16816-f16-bf16-A.png")
...
> ![sparse-mma-metadata-16816-f16bf16.png](../_images/sparse-mma-metadata-16816-f16bf16.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-metadata-16816-f16bf16.png")
> 
...
![Figure 120 Sparse MMA .m16n8k32 fragment layout for matrix A with `.f16`/`.bf16` type.](../_images/sparse-mma-16832-f16-bf16-A.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-16832-f16-bf16-A.png")
...
![Figure 121 Sparse MMA .m16n8k32 fragment layout for matrix B with `.f16`/`.bf16` type.](../_images/sparse-mma-16832-f16bf16-B.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-16832-f16bf16-B.png")
...
> ![sparse-mma-metadata-16832-f16bf16.png](../_images/sparse-mma-metadata-16832-f16bf16.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-metadata-16832-f16bf16.png")
> 
...
![Figure 123 Sparse MMA .m16n8k16 fragment layout for matrix A with `.tf32` type.](../_images/sparse-mma-16816-tf32-A.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-16816-tf32-A.png")
...
![Figure 124 Sparse MMA .m16n8k16 fragment layout for matrix B with `.tf32` type.](../_images/sparse-mma-16816-tf32-B.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-16816-tf32-B.png")
...
> ![sparse-mma-metadata-16816-tf32.png](../_images/sparse-mma-metadata-16816-tf32.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-metadata-16816-tf32.png")
> 
...
![Figure 126 Sparse MMA .m16n8k8 fragment layout for matrix A with `.tf32` type.](../_images/sparse-mma-1688-tf32-A.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-1688-tf32-A.png")
...
> ![sparse-mma-metadata-1688-tf32.png](../_images/sparse-mma-metadata-1688-tf32.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-metadata-1688-tf32.png")
> 
...
![Figure 128 Sparse MMA .m16n8k32 fragment layout for matrix A with `.u8`/`.s8` type.](../_images/sparse-mma-16832-u8s8-A.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-16832-u8s8-A.png")
...
> ![sparse-mma-metadata-16832-u8s8.png](../_images/sparse-mma-metadata-16832-u8s8.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-metadata-16832-u8s8.png")
> 
...
![Figure 130 Sparse MMA .m16n8k64 fragment layout for columns 0–31 of matrix A with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/sparse-mma-16864-u8s8-A-first32col.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-16864-u8s8-A-first32col.png")

Figure 130 Sparse MMA .m16n8k64 fragment layout for columns 0–31 of matrix A with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.

![Figure 131 Sparse MMA .m16n8k64 fragment layout for columns 32–63 of matrix A with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/sparse-mma-16864-u8s8-A-last32col.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-16864-u8s8-A-last32col.png")
...
![Figure 132 Sparse MMA .m16n8k64 fragment layout for rows 0–15 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/sparse-mma-16864-u8s8-B1.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-16864-u8s8-B1.png")

Figure 132 Sparse MMA .m16n8k64 fragment layout for rows 0–15 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.

![Figure 133 Sparse MMA .m16n8k64 fragment layout for rows 16–31 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/sparse-mma-16864-u8s8-B2.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-16864-u8s8-B2.png")

Figure 133 Sparse MMA .m16n8k64 fragment layout for rows 16–31 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.

![Figure 134 Sparse MMA .m16n8k64 fragment layout for rows 32–47 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/sparse-mma-16864-u8s8-B3.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-16864-u8s8-B3.png")

Figure 134 Sparse MMA .m16n8k64 fragment layout for rows 32–47 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.

![Figure 135 Sparse MMA .m16n8k64 fragment layout for rows 48–63 of matrix B with `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.](../_images/sparse-mma-16864-u8s8-B4.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-16864-u8s8-B4.png")
...
> ![sparse-mma-metadata-16864-u8s8-first32col.png](../_images/sparse-mma-metadata-16864-u8s8-first32col.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-metadata-16864-u8s8-first32col.png")
> 
> Figure 136 Sparse MMA .m16n8k64 metadata layout for columns 0–31 for `.u8`/`.s8`/`.e4m3`/`.e5m2`/`.e3m2`/`.e2m3`/`.e2m1` type.
> 
> ![sparse-mma-metadata-16864-u8s8-last32col.png](../_images/sparse-mma-metadata-16864-u8s8-last32col.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-metadata-16864-u8s8-last32col.png")
> 
...
![Figure 138 Sparse MMA .m16n8k64 fragment layout for matrix A with `.u4`/`.s4` type.](../_images/sparse-mma-16864-u4s4-A.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-16864-u4s4-A.png")
...
> ![sparse-mma-metadata-16864-u4s4.png](../_images/sparse-mma-metadata-16864-u4s4.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-metadata-16864-u4s4.png")
> 
...
![Figure 140 Sparse MMA .m16n8k128 fragment layout for columns 0–63 of matrix A with `.u4`/`.s4`/`.e2m1` type.](../_images/sparse-mma-168128-u4s4-A-first64col.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-168128-u4s4-A-first64col.png")

Figure 140 Sparse MMA .m16n8k128 fragment layout for columns 0–63 of matrix A with `.u4`/`.s4`/`.e2m1` type.

![Figure 141 Sparse MMA .m16n8k128 fragment layout for columns 64–127 of matrix A with `.u4`/`.s4`/`.e2m1` type.](../_images/sparse-mma-168128-u4s4-A-last64col.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-168128-u4s4-A-last64col.png")
...
![Figure 142 Sparse MMA .m16n8k128 fragment layout for rows 0–31 of matrix B with `.u4`/`.s4`/`.e2m1` type.](../_images/sparse-mma-168128-u4s4-B1.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-168128-u4s4-B1.png")

Figure 142 Sparse MMA .m16n8k128 fragment layout for rows 0–31 of matrix B with `.u4`/`.s4`/`.e2m1` type.

![Figure 143 Sparse MMA .m16n8k128 fragment layout for rows 32–63 of matrix B with `.u4`/`.s4`/`.e2m1` type.](../_images/sparse-mma-168128-u4s4-B2.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-168128-u4s4-B2.png")

Figure 143 Sparse MMA .m16n8k128 fragment layout for rows 32–63 of matrix B with `.u4`/`.s4`/`.e2m1` type.

![Figure 144 Sparse MMA .m16n8k128 fragment layout for rows 64–95 of matrix B with `.u4`/`.s4`/`.e2m1` type.](../_images/sparse-mma-168128-u4s4-B3.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-168128-u4s4-B3.png")

Figure 144 Sparse MMA .m16n8k128 fragment layout for rows 64–95 of matrix B with `.u4`/`.s4`/`.e2m1` type.

![Figure 145 Sparse MMA .m16n8k128 fragment layout for rows 96–127 of matrix B with `.u4`/`.s4`/`.e2m1` type.](../_images/sparse-mma-168128-u4s4-B4.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-168128-u4s4-B4.png")
...
> ![sparse-mma-metadata-168128-u4s4-first64col.png](../_images/sparse-mma-metadata-168128-u4s4-first64col.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-metadata-168128-u4s4-first64col.png")
> 
> Figure 146 Sparse MMA .m16n8k128 metadata layout for columns 0–63 for `.u4`/`.s4`/`.e2m1` type.
> 
> ![sparse-mma-metadata-168128-u4s4-last64col.png](../_images/sparse-mma-metadata-168128-u4s4-last64col.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/sparse-mma-metadata-168128-u4s4-last64col.png")
> 
