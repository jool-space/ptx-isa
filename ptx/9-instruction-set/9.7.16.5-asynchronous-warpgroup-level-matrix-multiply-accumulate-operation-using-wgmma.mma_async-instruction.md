...
####### 9.7.16.5.1.1.1. Matrix Fragments for `wgmma.mma_async.m64nNk16`
...
![Figure 148 WGMMA .m64nNk16 register fragment layout for matrix A.](../_images/wgmma-64N16-A.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/wgmma-64N16-A.png")
...
![Figure 149 WGMMA .m64nNk16 register fragment layout for accumulator matrix D.](../_images/wgmma-64N16-D.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/wgmma-64N16-D.png")

Figure 149 WGMMA .m64nNk16 register fragment layout for accumulator matrix D.


####### 9.7.16.5.1.1.2. Matrix Fragments for `wgmma.mma_async.m64nNk8`
...
![Figure 150 WGMMA .m64nNk8 register fragment layout for matrix A.](../_images/wgmma-64N8-A.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/wgmma-64N8-A.png")
...
![Figure 151 WGMMA .m64nNk8 register fragment layout for accumulator matrix D.](../_images/wgmma-64N8-D.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/wgmma-64N8-D.png")

Figure 151 WGMMA .m64nNk8 register fragment layout for accumulator matrix D.


####### 9.7.16.5.1.1.3. Matrix Fragments for `wgmma.mma_async.m64nNk32`
...
![Figure 152 WGMMA .m64nNk32 register fragment layout for matrix A.](../_images/wgmma-64N32-A.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/wgmma-64N32-A.png")
...
![Figure 153 WGMMA .m64nNk32 register fragment layout for accumulator matrix D.](../_images/wgmma-64N32-D.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/wgmma-64N32-D.png")

Figure 153 WGMMA .m64nNk32 register fragment layout for accumulator matrix D.


####### 9.7.16.5.1.1.4. Matrix Fragments for `wgmma.mma_async.m64nNk256`
...
![Figure 154 WGMMA .m64nNk256 register fragment layout for matrix A.](../_images/wgmma-64N256-A.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/wgmma-64N256-A.png")
...
![Figure 155 WGMMA .m64nNk256 register fragment layout for accumulator matrix D.](../_images/wgmma-64N256-D.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/wgmma-64N256-D.png")
...
The matrices in the shared memory are made up of one or more “swizzle layout atom”. The exact layout of these swizzle atoms depends on the swizzling mode, swizzle-atomicity, and the leading dimension. The layout of the swizzle are shown in Table 41.
...
The following are some example layouts of _MxK_ or _KxN_ matrices with various swizzling modes, and are in units of 128b elements as shown by each colored cell as shown in Figure 156, Figure 157, Figure 158, Figure 159, Figure 160, Figure 161, Figure 162, Figure 163.

![Figure 156 MN major 128B swizzling](../_images/async-warpgroup-smem-layout-128B-mn.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-smem-layout-128B-mn.png")

Figure 156 MN major 128B swizzling

![Figure 157 K major 128B swizzling](../_images/async-warpgroup-smem-layout-128B-k.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-smem-layout-128B-k.png")

Figure 157 K major 128B swizzling

![Figure 158 MN major 64B swizzling](../_images/async-warpgroup-smem-layout-64B-mn.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-smem-layout-64B-mn.png")

Figure 158 MN major 64B swizzling

![Figure 159 K major 64B swizzling](../_images/async-warpgroup-smem-layout-64B-k.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-smem-layout-64B-k.png")

Figure 159 K major 64B swizzling

![Figure 160 MN major 32B swizzling](../_images/async-warpgroup-smem-layout-32B-mn.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-smem-layout-32B-mn.png")

Figure 160 MN major 32B swizzling

![Figure 161 K major 32B swizzling](../_images/async-warpgroup-smem-layout-32B-k.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-smem-layout-32B-k.png")

Figure 161 K major 32B swizzling

![Figure 162 MN major interleaved](../_images/async-warpgroup-smem-layout-mn-interleaved.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-smem-layout-mn-interleaved.png")

Figure 162 MN major interleaved

![Figure 163 K major interleaved](../_images/async-warpgroup-smem-layout-k-interleaved.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-smem-layout-k-interleaved.png")
...
####### 9.7.16.5.1.2.1. Major-ness supported by Strides
...
######## 9.7.16.5.1.2.1.1. Leading Dimension Byte Offset
...
######## 9.7.16.5.1.2.1.2. Stride Dimension Byte Offset
...
######## 9.7.16.5.1.2.1.3. Canonical Layouts
...
![Figure 166 K major, no-swizzling and tf32 type](../_images/async-warpgroup-k-no-swizzle-tf32.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-k-no-swizzle-tf32.png")
...
![Figure 167 K major, 32B swizzling and tf32 type](../_images/async-warpgroup-k-32B-swizzle-tf32.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-k-32B-swizzle-tf32.png")
...
![Figure 168 MN major, no-swizzling and bf16 type](../_images/async-warpgroup-mn-no-swizzle-bf16.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-mn-no-swizzle-bf16.png")
...
![Figure 169 MN major, 32B swizzling and bf16 type](../_images/async-warpgroup-mn-32B-swizzle-bf16.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-mn-32B-swizzle-bf16.png")
...
![Figure 170 MN major, 64B swizzling and bf16 type](../_images/async-warpgroup-mn-64B-swizzle-bf16.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/async-warpgroup-mn-64B-swizzle-bf16.png")
...
####### 9.7.16.5.1.2.2. Matrix Descriptor Format
