...
Table 49 Transpose and Negate operation for various MMA-Kind MMA-Kind | Is Transpose A/B supported | Is Negate A/B supported  
---|---|---  
`.kind::tf32` | Yes | Yes  
`.kind::f16` | Yes | Yes  
`.kind::f8f6f4` | Yes | Yes  
...
Table 50 Various combinations of N shape with .cta_group qualifier for 8bit transpose B .cta_group | N shape  
---|---  
1 | 16 <= N <= 256, step 16  
2 | 32 <= N <= 256, step 32
...
Table 51 Major-ness for different matrices Matrix | Residing in Memory | Default Major-ness  
---|---|---  
...
Table 52 Valid Combinations of Type-Size, Major-ness and Swizzling Type-Size | Major-ness | Matrix | Supported Swizzle  
---|---|---|---  
...
![Figure 199 4-bit packing format with type E2M1](../_images/tcgen05-packing-formats-mxf8f6f4-tmem-dig1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-packing-formats-mxf8f6f4-tmem-dig1.png")
...
![Figure 200 6-bit packing format with type E3M2](../_images/tcgen05-packing-formats-mxf8f6f4-tmem-dig2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-packing-formats-mxf8f6f4-tmem-dig2.png")

Figure 200 6-bit packing format with type E3M2

    * Type E2M3 as shown in Figure 201

![Figure 201 6-bit packing format with type E2M3](../_images/tcgen05-packing-formats-mxf8f6f4-tmem-dig3.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-packing-formats-mxf8f6f4-tmem-dig3.png")
...
![Figure 202 4-bit packing format](../_images/tcgen05-packing-formats-mxf8f6f4-smem-dig1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-packing-formats-mxf8f6f4-smem-dig1.png")
...
> ![tcgen05-packing-formats-mxf8f6f4-smem-dig2.png](../_images/tcgen05-packing-formats-mxf8f6f4-smem-dig2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-packing-formats-mxf8f6f4-smem-dig2.png")
> 
...
![Figure 204 4-bit packing format with type E2M1](../_images/tcgen05-packing-formats-mxf4-tmem-dig1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-packing-formats-mxf4-tmem-dig1.png")
...
![Figure 205 Layout organization for M = 256](../_images/tcgen05-data-path-layout-a1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-a1.png")
...
![Figure 206 Addresses to use in `tcgen05.ld` / `tcgen05.st`](../_images/tcgen05-data-path-layout-a2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-a2.png")
...
![Figure 207 Layout organization for M = 128 + .cta_group::2 + Dense A matrix](../_images/tcgen05-data-path-layout-b1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-b1.png")
...
![Figure 208 Addresses to use in `tcgen05.ld` / `tcgen05.st`](../_images/tcgen05-data-path-layout-b2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-b2.png")
...
![Figure 209 Layout organization for M = 128 + .cta_group::2 + Sparse A matrix](../_images/tcgen05-data-path-layout-c1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-c1.png")
...
![Figure 210 Addresses to use in `tcgen05.ld` / `tcgen05.st`](../_images/tcgen05-data-path-layout-c2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-c2.png")
...
![Figure 211 Layout organization for M = 128 + .cta_group::1](../_images/tcgen05-data-path-layout-d1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-d1.png")
...
![Figure 212 Addresses to use in `tcgen05.ld` / `tcgen05.st`](../_images/tcgen05-data-path-layout-d2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-d2.png")
...
![Figure 213 Layout organization for M = 64 + .ws mode](../_images/tcgen05-data-path-layout-e1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-e1.png")
...
![Figure 214 Addresses to use in `tcgen05.ld` / `tcgen05.st`](../_images/tcgen05-data-path-layout-e2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-e2.png")
...
![Figure 215 Layout organization for M = 64 + non .ws mode](../_images/tcgen05-data-path-layout-f1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-f1.png")
...
![Figure 216 Addresses to use in `tcgen05.ld` / `tcgen05.st`](../_images/tcgen05-data-path-layout-f2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-f2.png")
...
![Figure 217 Layout organization for M = 32](../_images/tcgen05-data-path-layout-g1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-g1.png")
...
![Figure 218 Addresses to use in `tcgen05.ld` / `tcgen05.st`](../_images/tcgen05-data-path-layout-g2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-data-path-layout-g2.png")
...
Table 53 Layout for swizzle atoms Swizzling mode and Swizzle-Atomicity | Leading Dimension | Swizzle atom layout (128b element)  
---|---|---  
...
![Figure 219 MN major 128B swizzling with 32B atomicity](../_images/tcgen05-smem-layout-128B-32B-atom-mn.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-smem-layout-128B-32B-atom-mn.png")

Figure 219 MN major 128B swizzling with 32B atomicity

![Figure 220 MN major 128B swizzling](../_images/tcgen05-smem-layout-128B-mn.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-smem-layout-128B-mn.png")

Figure 220 MN major 128B swizzling

![Figure 221 K major 128B swizzling](../_images/tcgen05-smem-layout-128B-k.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-smem-layout-128B-k.png")

Figure 221 K major 128B swizzling

![Figure 222 MN major 64B swizzling](../_images/tcgen05-smem-layout-64B-mn.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-smem-layout-64B-mn.png")

Figure 222 MN major 64B swizzling

![Figure 223 K major 64B swizzling](../_images/tcgen05-smem-layout-64B-k.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-smem-layout-64B-k.png")

Figure 223 K major 64B swizzling

![Figure 224 MN major 32B swizzling](../_images/tcgen05-smem-layout-32B-mn.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-smem-layout-32B-mn.png")

Figure 224 MN major 32B swizzling

![Figure 225 K major 32B swizzling](../_images/tcgen05-smem-layout-32B-k.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-smem-layout-32B-k.png")

Figure 225 K major 32B swizzling

![Figure 226 MN major no-swizzling mode](../_images/tcgen05-smem-layout-no-swizzle-mn.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-smem-layout-no-swizzle-mn.png")

Figure 226 MN major no-swizzling mode

![Figure 227 K major no-swizzling mode](../_images/tcgen05-smem-layout-no-swizzle-k.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-smem-layout-no-swizzle-k.png")
...
> ![tcgen05-smem-layout-k.png](../_images/tcgen05-smem-layout-k.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-smem-layout-k.png")
> 
> Figure 228 K major

  * MN-Major: Figure 229

> ![tcgen05-smem-layout-mn.png](../_images/tcgen05-smem-layout-mn.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-smem-layout-mn.png")
> 
> Figure 229 MN major
...
![Figure 230 `tcgen05.mma` with block scaling of `scale_vec::2X`](../_images/tcgen05-mma-block-scaling.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-block-scaling.png")
...
The shape of _scale_A_ and _scale_B_ matrices depend on the `.scale_vectorsize` as shown in Table 54.

Table 54 Valid combinations of scale_vectorsize and shapes .scale_vectorsize | .kind::* | K | Shape of scale_A | Shape of scale_B  
---|---|---|---|---  
...
Table 55 Valid combinations of scale_vectorsize with types and MMA-Kind .kind::* | Element Data Type | Scale Data Type | .scale_vectorsize  
---|---|---|---  
...
![Figure 231 Layout of scale factor A matrix with scale_vec::1X/block32 with K=32/K=64](../_images/tcgen05-mma-scale-factor-a-1x-dig.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-a-1x-dig.png")
...
![Figure 232 Layout of scale factor A matrix with scale_vec::2X/block32 with K=64/K=128](../_images/tcgen05-mma-scale-factor-a-2x-dig.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-a-2x-dig.png")
...
![Figure 233 Layout of scale factor A matrix with scale_vec::4X/block16 with K=64/K=128](../_images/tcgen05-mma-scale-factor-a-4x-dig.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-a-4x-dig.png")
...
![Figure 234 Layout of scale factor A matrix with block32 with K=96 with SFA_ID=00](../_images/tcgen05-mma-scale-factor-a-block32-k96-dig1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-a-block32-k96-dig1.png")

Figure 234 Layout of scale factor A matrix with block32 with K=96 with SFA_ID=00

![Figure 235 Layout of scale factor A matrix with block32 with K=96 with SFA_ID=01](../_images/tcgen05-mma-scale-factor-a-block32-k96-dig2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-a-block32-k96-dig2.png")

Figure 235 Layout of scale factor A matrix with block32 with K=96 with SFA_ID=01

![Figure 236 Layout of scale factor A matrix with block32 with K=96 with SFA_ID=10](../_images/tcgen05-mma-scale-factor-a-block32-k96-dig3.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-a-block32-k96-dig3.png")

Figure 236 Layout of scale factor A matrix with block32 with K=96 with SFA_ID=10

![Figure 237 Layout of scale factor A matrix with block32 with K=96 with SFA_ID=11](../_images/tcgen05-mma-scale-factor-a-block32-k96-dig4.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-a-block32-k96-dig4.png")
...
![Figure 238 Layout of scale factor A matrix with block16 with K=96 with SFA_ID=00](../_images/tcgen05-mma-scale-factor-a-block16-k96-dig1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-a-block16-k96-dig1.png")

Figure 238 Layout of scale factor A matrix with block16 with K=96 with SFA_ID=00

![Figure 239 Layout of scale factor A matrix with block16 with K=96 with SFA_ID=10](../_images/tcgen05-mma-scale-factor-a-block16-k96-dig2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-a-block16-k96-dig2.png")
...
![Figure 240 Layout of scale factor B matrix with scale_vec::1X/block32 with K=32/K=64](../_images/tcgen05-mma-scale-factor-b-1x-dig.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-1x-dig.png")
...
![Figure 241 Layout of scale factor B matrix with scale_vec::2X/block32 with K=64/K=128](../_images/tcgen05-mma-scale-factor-b-2x-dig.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-2x-dig.png")
...
![Figure 242 Layout of scale factor B matrix with scale_vec::4X/block16 with K=64/K=128](../_images/tcgen05-mma-scale-factor-b-4x-dig.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-4x-dig.png")
...
![Figure 243 Layout of scale factor B matrix with block32 with K=96 and N<=128 with SFA_ID=00](../_images/tcgen05-mma-scale-factor-b-block32-k96-nlt128-dig1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block32-k96-nlt128-dig1.png")

Figure 243 Layout of scale factor B matrix with block32 with K=96 and N<=128 with SFA_ID=00

![Figure 244 Layout of scale factor B matrix with block32 with K=96 and N<=128 with SFA_ID=01](../_images/tcgen05-mma-scale-factor-b-block32-k96-nlt128-dig2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block32-k96-nlt128-dig2.png")

Figure 244 Layout of scale factor B matrix with block32 with K=96 and N<=128 with SFA_ID=01

![Figure 245 Layout of scale factor B matrix with block32 with K=96 and N<=128 with SFA_ID=10](../_images/tcgen05-mma-scale-factor-b-block32-k96-nlt128-dig3.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block32-k96-nlt128-dig3.png")

Figure 245 Layout of scale factor B matrix with block32 with K=96 and N<=128 with SFA_ID=10

![Figure 246 Layout of scale factor B matrix with block32 with K=96 and N<=128 with SFA_ID=11](../_images/tcgen05-mma-scale-factor-b-block32-k96-nlt128-dig4.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block32-k96-nlt128-dig4.png")
...
![Figure 247 Layout of scale factor B matrix with block32 with K=96 and N>128 with SFA_ID=00](../_images/tcgen05-mma-scale-factor-b-block32-k96-ngt128-dig1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block32-k96-ngt128-dig1.png")

Figure 247 Layout of scale factor B matrix with block32 with K=96 and N>128 with SFA_ID=00

![Figure 248 Layout of scale factor B matrix with block32 with K=96 and N>128 with SFA_ID=01](../_images/tcgen05-mma-scale-factor-b-block32-k96-ngt128-dig2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block32-k96-ngt128-dig2.png")

Figure 248 Layout of scale factor B matrix with block32 with K=96 and N>128 with SFA_ID=01

![Figure 249 Layout of scale factor B matrix with block32 with K=96 and N>128 with SFA_ID=10](../_images/tcgen05-mma-scale-factor-b-block32-k96-ngt128-dig3.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block32-k96-ngt128-dig3.png")

Figure 249 Layout of scale factor B matrix with block32 with K=96 and N>128 with SFA_ID=10

![Figure 250 Layout of scale factor B matrix with block32 with K=96 and N>128 with SFA_ID=10](../_images/tcgen05-mma-scale-factor-b-block32-k96-ngt128-dig4.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block32-k96-ngt128-dig4.png")

Figure 250 Layout of scale factor B matrix with block32 with K=96 and N>128 with SFA_ID=10

![Figure 251 Layout of scale factor B matrix with block32 with K=96 and N>128 with SFA_ID=11](../_images/tcgen05-mma-scale-factor-b-block32-k96-ngt128-dig5.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block32-k96-ngt128-dig5.png")

Figure 251 Layout of scale factor B matrix with block32 with K=96 and N>128 with SFA_ID=11

![Figure 252 Layout of scale factor B matrix with block32 with K=96 and N>128 with SFA_ID=11](../_images/tcgen05-mma-scale-factor-b-block32-k96-ngt128-dig6.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block32-k96-ngt128-dig6.png")
...
![Figure 253 Layout of scale factor B matrix with block16 with K=96 and N<=128 with SFA_ID=00](../_images/tcgen05-mma-scale-factor-b-block16-k96-nlt128-dig1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block16-k96-nlt128-dig1.png")

Figure 253 Layout of scale factor B matrix with block16 with K=96 and N<=128 with SFA_ID=00

![Figure 254 Layout of scale factor B matrix with block16 with K=96 and N<=128 with SFA_ID=10](../_images/tcgen05-mma-scale-factor-b-block16-k96-nlt128-dig2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block16-k96-nlt128-dig2.png")
...
![Figure 255 Layout of scale factor B matrix with block16 with K=96 and N>128 with SFA_ID=00](../_images/tcgen05-mma-scale-factor-b-block16-k96-ngt128-dig1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block16-k96-ngt128-dig1.png")

Figure 255 Layout of scale factor B matrix with block16 with K=96 and N>128 with SFA_ID=00

![Figure 256 Layout of scale factor B matrix with block16 with K=96 and N>128 with SFA_ID=00](../_images/tcgen05-mma-scale-factor-b-block16-k96-ngt128-dig2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block16-k96-ngt128-dig2.png")

Figure 256 Layout of scale factor B matrix with block16 with K=96 and N>128 with SFA_ID=00

![Figure 257 Layout of scale factor B matrix with block16 with K=96 and N>128 with SFA_ID=10](../_images/tcgen05-mma-scale-factor-b-block16-k96-ngt128-dig3.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block16-k96-ngt128-dig3.png")

Figure 257 Layout of scale factor B matrix with block16 with K=96 and N>128 with SFA_ID=10

![Figure 258 Layout of scale factor B matrix with block16 with K=96 and N>128 with SFA_ID=10](../_images/tcgen05-mma-scale-factor-b-block16-k96-ngt128-dig4.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-mma-scale-factor-b-block16-k96-ngt128-dig4.png")
...
![Figure 259 Sparse tcgen05.mma metadata example for tf32 kind](../_images/tcgen05-sparse-mma-metadata-tf32.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-sparse-mma-metadata-tf32.png")
...
![Figure 260 Sparse tcgen05.mma metadata example for f16/f8f6f4/mxf8f6f4 kind](../_images/tcgen05-sparse-mma-metadata-f16-f8f6f4-mxf8f6f4.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-sparse-mma-metadata-f16-f8f6f4-mxf8f6f4.png")
...
![Figure 261 Sparse tcgen05.mma metadata example for mxf4 kind](../_images/tcgen05-sparse-mma-metadata-mxf4.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-sparse-mma-metadata-mxf4.png")
...
![Figure 262 Sparsity Metadata Layout for M = 64 for `.kind::f16`](../_images/tcgen05-sparse-matrices-sparsity-selector-kind-f16-m64.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-sparse-matrices-sparsity-selector-kind-f16-m64.png")
...
![Figure 263 Sparsity Metadata Layout for M = 128 / M = 256 for `.kind::f16`](../_images/tcgen05-sparse-matrices-sparsity-selector-kind-f16-m128-256.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-sparse-matrices-sparsity-selector-kind-f16-m128-256.png")
...
![Figure 264 Sparsity Metadata Layout for M = 64 for `.kind::tf32`](../_images/tcgen05-sparse-matrices-sparsity-selector-kind-tf32-m64.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-sparse-matrices-sparsity-selector-kind-tf32-m64.png")
...
![Figure 265 Sparsity Metadata Layout for M = 128 / M = 256 for `.kind::tf32`](../_images/tcgen05-sparse-matrices-sparsity-selector-kind-tf32-m128-256.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tcgen05-sparse-matrices-sparsity-selector-kind-tf32-m128-256.png")
