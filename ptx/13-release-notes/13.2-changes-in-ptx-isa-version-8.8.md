...
PTX ISA version 8.8 introduces the following new features:
  ...
  * Table 58 shows the list of features that are supported on family-specific targets:

Table 58 List of features promoted to family-specific architecture Feature | Supported targets  
---|---  
