...
![Figure 11 im2col mode bounding box example 1](../_images/tensor-im2col-mode-bounding-box1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tensor-im2col-mode-bounding-box1.png")  
  
Figure 11 im2col mode bounding box example 1


![Figure 12 im2col mode bounding box example 2](../_images/tensor-im2col-mode-bounding-box2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tensor-im2col-mode-bounding-box2.png")
...
![Figure 13 im2col mode example 1](../_images/tensor-im2col-mode-example1.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tensor-im2col-mode-example1.png")
...
![Figure 14 im2col mode example 2](../_images/tensor-im2col-mode-example2.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tensor-im2col-mode-example2.png")
