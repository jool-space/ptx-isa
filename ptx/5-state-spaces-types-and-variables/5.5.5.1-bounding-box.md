...
![Figure 16 im2col::w and im2col::w::128 modes example](../_images/tensor-im2col-w-w128-modes-example.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/tensor-im2col-w-w128-modes-example.png")
...
![Figure 17 im2col::w and im2col::w::128 modes first element outside Bounding Box example](../_images/tensor-im2col-w-w128-modes-example2.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/tensor-im2col-w-w128-modes-example2.png")
