...
![Figure 18 tensor copy operation with im2col::w mode example](../_images/tensor-im2col-w-w128-modes-example3.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/tensor-im2col-w-w128-modes-example3.png")
...
![Figure 19 tensor copy operation with im2col::w::128 mode example](../_images/tensor-im2col-w-w128-modes-example4.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/tensor-im2col-w-w128-modes-example4.png")
