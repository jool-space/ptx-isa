...
![Figure 15 im2col mode traversal stride example](../_images/tensor-im2col-mode-example3.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-im2col-mode-example3.png")
