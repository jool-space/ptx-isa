...
![Figure 15 im2col mode traversal stride example](../_images/tensor-im2col-mode-example3.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/tensor-im2col-mode-example3.png")
