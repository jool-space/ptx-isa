...
![Figure 10 tiled::scatter4/tiled::gather4 mode bounding box example](../_images/tiled-scatter4-gather4-bounding-box.png "https://docs.nvidia.com/cuda/archive/13.0.1/parallel-thread-execution/_images/tiled-scatter4-gather4-bounding-box.png")
