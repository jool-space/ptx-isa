...
![Figure 25 32-byte swizzle mode example](../_images/tensor-32B-swizzle.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/tensor-32B-swizzle.png")
...
![Figure 26 32-byte swizzle mode fragments](../_images/tensor-32B-swizzle-frag.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/tensor-32B-swizzle-frag.png")

Figure 26 32-byte swizzle mode fragments

Figure 27 shows the destination data layout with 32 byte swizzling.

![Figure 27 32-byte swizzle mode destination data layout](../_images/tensor-32B-swizzle-dst.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/tensor-32B-swizzle-dst.png")
...
![Figure 28 64-byte swizzle mode example](../_images/tensor-64B-swizzle.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/tensor-64B-swizzle.png")

Figure 28 64-byte swizzle mode example

Each colored cell represents 8 channels. Figure 29 shows the source data layout.

![Figure 29 64-byte swizzle mode source data layout](../_images/tensor-64B-swizzle-src.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/tensor-64B-swizzle-src.png")

Figure 29 64-byte swizzle mode source data layout

Figure 30 shows the destination data layout with 64 byte swizzling.

![Figure 30 64-byte swizzle mode destination data layout](../_images/tensor-64B-swizzle-dst.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/tensor-64B-swizzle-dst.png")
...
![Figure 31 96-byte swizzle mode example](../_images/tensor-96B-swizzle.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/tensor-96B-swizzle.png")
...
![Figure 32 128-byte swizzle mode example](../_images/tensor-128B-swizzle.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/tensor-128B-swizzle.png")

Figure 32 128-byte swizzle mode example

Each colored cell represents 8 channels. Figure 33 shows the source data layout.

![Figure 33 128-byte swizzle mode source data layout](../_images/tensor-128B-swizzle-src.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/tensor-128B-swizzle-src.png")

Figure 33 128-byte swizzle mode source data layout

Figure 34 shows the destination data layout with 128 byte swizzling.

![Figure 34 128-byte swizzle mode destination data layout](../_images/tensor-128B-swizzle-dst.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/tensor-128B-swizzle-dst.png")
...
![Figure 35 128-byte swizzle mode example with 32-byte atomicity](../_images/tensor-128B-swizzle-32B-atom.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/tensor-128B-swizzle-32B-atom.png")
...
![Figure 36 128-byte swizzle mode example with 32-byte atomicity with 8-byte flip](../_images/tensor-128B-swizzle-32B-atom-8B-flip.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/tensor-128B-swizzle-32B-atom-8B-flip.png")
...
![Figure 37 128-byte swizzle mode example with 64-byte atomicity](../_images/tensor-128B-swizzle-64B-atom.png "https://docs.nvidia.com/cuda/archive/13.2.1/parallel-thread-execution/_images/tensor-128B-swizzle-64B-atom.png")
