...
![Figure 26 32-byte swizzle mode example](../_images/tensor-32B-swizzle.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-32B-swizzle.png")
...
![Figure 27 32-byte swizzle mode fragments](../_images/tensor-32B-swizzle-frag.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-32B-swizzle-frag.png")

Figure 27 32-byte swizzle mode fragments

Figure 28 shows the destination data layout with 32 byte swizzling.

![Figure 28 32-byte swizzle mode destination data layout](../_images/tensor-32B-swizzle-dst.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-32B-swizzle-dst.png")
...
![Figure 29 64-byte swizzle mode example](../_images/tensor-64B-swizzle.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-64B-swizzle.png")

Figure 29 64-byte swizzle mode example

Each colored cell represents 8 channels. Figure 30 shows the source data layout.

![Figure 30 64-byte swizzle mode source data layout](../_images/tensor-64B-swizzle-src.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-64B-swizzle-src.png")

Figure 30 64-byte swizzle mode source data layout

Figure 31 shows the destination data layout with 64 byte swizzling.

![Figure 31 64-byte swizzle mode destination data layout](../_images/tensor-64B-swizzle-dst.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-64B-swizzle-dst.png")
...
![Figure 32 96-byte swizzle mode example](../_images/tensor-96B-swizzle.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-96B-swizzle.png")
...
![Figure 33 128-byte swizzle mode example](../_images/tensor-128B-swizzle.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-128B-swizzle.png")

Figure 33 128-byte swizzle mode example

Each colored cell represents 8 channels. Figure 34 shows the source data layout.

![Figure 34 128-byte swizzle mode source data layout](../_images/tensor-128B-swizzle-src.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-128B-swizzle-src.png")

Figure 34 128-byte swizzle mode source data layout

Figure 35 shows the destination data layout with 128 byte swizzling.

![Figure 35 128-byte swizzle mode destination data layout](../_images/tensor-128B-swizzle-dst.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-128B-swizzle-dst.png")
...
![Figure 36 128-byte swizzle mode example with 32-byte atomicity](../_images/tensor-128B-swizzle-32B-atom.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-128B-swizzle-32B-atom.png")
...
![Figure 37 128-byte swizzle mode example with 32-byte atomicity with 8-byte flip](../_images/tensor-128B-swizzle-32B-atom-8B-flip.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-128B-swizzle-32B-atom-8B-flip.png")
...
![Figure 38 128-byte swizzle mode example with 64-byte atomicity](../_images/tensor-128B-swizzle-64B-atom.png "https://docs.nvidia.com/cuda/parallel-thread-execution/_images/tensor-128B-swizzle-64B-atom.png")
