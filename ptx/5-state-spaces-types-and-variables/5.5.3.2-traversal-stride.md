...
![Figure 8 Tiled mode bounding box, tensor size and traversal stride](../_images/tensor-tiled-mode-bounding-box-example.png "https://docs.nvidia.com/cuda/archive/13.1.1/parallel-thread-execution/_images/tensor-tiled-mode-bounding-box-example.png")
